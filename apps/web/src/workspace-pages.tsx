    ...
    <div className="app-shell">
      <aside className="sidebar">
        <div className="sidebar-top">
          <BrandLockup caption="Browser-side policy control plane" />
        ...
        <div className="sidebar-bottom">
          ...
          <button
            ...
            type="button"
          >
            <IconText icon="launch" tone="neutral" className="button-label">Sign out</IconText>
          </button>
        </div>
      </aside>
      ...
      <main className="workspace">
        <header className="workspace-header">
          ...
          <div className="workspace-header-meta">
            ...
            <span className="meta-pill">
              <UiGlyph name="billing" />
              <span>{titleCase(session.entitlement.plan)}</span>
            </span>
            <span className="meta-pill">
              <UiGlyph name="shield" />
              <span>{titleCase(session.entitlement.status)}</span>
            </span>
          </div>
        </header>
        <Outlet />
